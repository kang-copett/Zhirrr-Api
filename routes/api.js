...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@Rafizqisss','@zhirrganteng','@zahirrgantengg', '@hafizh'];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Rafizwi'+'Ganteng--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'Rafizqi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Rafizqi') return res.json(loghandler.invalidKey)
